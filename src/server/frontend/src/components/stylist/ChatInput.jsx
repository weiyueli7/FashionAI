...
export default function ChatInput({
    ...
    selectedModel,
    onModelChange,
    persistentQueryText = '', // New prop to handle persistent query
    onQueryChange, // New prop to handle query changes
    ...
    // Update local state when persistent query changes
    useEffect(() => {
        if (persistentQueryText !== message) {
            setMessage(persistentQueryText);
            adjustTextAreaHeight();
        }
    }, [persistentQueryText]); // New
    ...
    const handleSubmit = () => {
        ...
        if (message.trim() || selectedImage) {
            ...
            console.log('User Input:', newMessage);
        ...
        <div className="bg-white/80 backdrop-blur-lg rounded-xl shadow-lg p-6">
            ...
            <div className="relative mb-4">
                <textarea
                    ...
                    // placeholder={fashionItems ? "Not happy with the recommendations? Try again here." : "What are you looking for today?"}
                    value={message}
